...
class DayTest < PunchTest
  ...
  def test_total
    ...
    day.add BlockCreator.from("08:00-12:00", day)
    day.add BlockCreator.from("13:00-18:00", day)
  ...
  def test_total_over_midnight
    ...
    day.add BlockCreator.from('23-02', day)
  ...
  def test_total_with_minutes
    day = Day.from '08.04.91'
    day.add BlockCreator.from("12:30-19:15", day)
    assert_equal '06:45', day.total_str
  end

  def test_block_ordering
    day = Day.from '26.03.89'
    day.add BlockCreator.from("13:30-17:00", day)
    day.add BlockCreator.from("06:00-11:45", day)
  ...
  def test_add_deletes_smaller_blocks
    day = Day.from '26.03.89'
    day.add BlockCreator.from("13:15-17:00", day)
  ...
  def test_add_ignores_new_smaller_blocks
    ...
    day.add BlockCreator.from("13:00-17:00", day)
    day.add BlockCreator.from("14:00-16:00", day)
  ...
  def test_prepend_merge2
    ...
    day.add BlockCreator.from("17:50-19:00", day)
    day.add BlockCreator.from("18:30-19:00", day)
  ...
  def test_append_merge
    day = Day.from '12.04.95'
    day.add BlockCreator.from("13:00-17:00", day)
    day.add BlockCreator.from("16:00-18:00", day)
  ...
  def test_connect_merge
    ...
    day.add BlockCreator.from("08:00-12:00", day)
    day.add BlockCreator.from("16:00-18:00", day)
    day.add BlockCreator.from("10:00-17:00", day)
  ...
  def test_connect_merge2
    day = Day.from '03.05.15'
    day.add BlockCreator.from("08:00-12:00", day),
      BlockCreator.from("16:00-18:00", day),
      BlockCreator.from("13:00-14:00", day),
      BlockCreator.from("22:00-23:00", day),
      BlockCreator.from("10:00-17:00", day)
  ...
  def test_connect_merge3
    ...
    day.add BlockCreator.from("08:00-12:00", day),
      BlockCreator.from("16:00-18:00", day),
      BlockCreator.from("12:00-16:00", day)
    assert_equal '03.05.15   08:00-18:00   Total: 10:00', day.to_s
  end
  ...
  def test_remove_at_end
    day = Day.from '03.05.15'
    day.add BlockCreator.from("08:00-12:00", day)
    day.remove BlockCreator.from("11:00-13:00", day)
